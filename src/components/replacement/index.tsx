...
const Replacement = () => {
  return (
      <main className='w-full h-[434px] py-[40px] border-b-[1px] border-[#232226]'>
          <section className='w-full h-full lg:max-w-[1200px] mx-auto flex justify-between'>
              ...
              {/* right */}
              <div className='w-[585px] flex flex-col gap-6'>
                  <h4 className='text-white text-xl font-normal tracking-[-1px]'>Replacement is an engineering approach to aging that requires fewer fundamental advances in discovery in aging/biology.</h4>
                  ...
                  <button className='w-[302px] py-2 flex items-center justify-center bg-[#FF7120] gap-2'>
